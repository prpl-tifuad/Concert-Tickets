      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
				...
				<h1 class="h3 mb-0 text-gray-800">Input Data Konser</h1>
...
?>        
		...
		<div>
			<br><br><br>
			<p>Konser Saat ini -- Click To Edit</p>
		</div>
			<div class="row">
    			...
    			<div class="col-md-3">
     				<div class="thumbnail">
          			...
          			<div class="caption">
                <a href="editkonser.php?kodekonser=<?= $data['kodekonser']; ?>"><p><?= $data['namakonser'] ?></p>
         			</div>       
    			</div>
